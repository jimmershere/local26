...
Both package formats install Local-26 as an application bundle under `/opt/local26`,
expose `/usr/bin/local26`, ship `/etc/local26/local26.ini.example`, and require a
