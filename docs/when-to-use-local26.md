# When to use Local-26

Use Local-26 when you want a lean, operator-readable deployment and runbook control plane for file sync, plan-first deploys, history, diagnostics, and repeatable shell-oriented workflows.
...
## Decision test
Local-26 is probably a good fit if you want:
