# LOCAL-81 Config Schema v0.1

This document defines the canonical `.local81/config.ini` contract for LOCAL-81 v0.1.
...
| `lock_file` | path | yes | `.local81/local81.lock` | Global LOCAL-81 lock file. |
