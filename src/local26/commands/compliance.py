...
from local26.compliance.artifacts import write_artifacts
from local26.compliance.models import SEVERITY_ORDER
...
def _profile(args: Namespace, defaults: dict[str, Any]) -> str:
    return args.compliance_profile or str(defaults.get("profile") or "nist-cms-local26")
