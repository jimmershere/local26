...
def list_runs(*, runs_dir: str = ".local26/runs", limit: int = 20) -> list[dict]:
    """Return recent run summaries, newest first."""
    runs_path = Path(runs_dir)
    if not runs_path.is_dir() and runs_dir == ".local26/runs":
...
def render_history(*, runs_dir: str = ".local26/runs", limit: int = 20) -> str:
