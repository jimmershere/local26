...
test_rollback_runs_on_failure() {
  ...
  python3 - <<PY "$tmpdir/.local81/plans/test.plan.json" "$rb_log"
import json, sys
...
test_per_step_on_failure_hook() {
  ...
  python3 - <<PY "$tmpdir/.local81/plans/test.plan.json" "$hook_log"
import json, sys
...
test_global_on_failure_hook() {
  ...
  python3 - <<PY "$tmpdir/.local81/plans/test.plan.json" "$global_log"
import json, sys
